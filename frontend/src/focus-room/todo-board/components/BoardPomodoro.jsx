export function BoardPomodoro({ pomodoro }) {
  if (!pomodoro) {
    return (
      <div className="focus-board-pomodoro focus-mode">
        <div className="focus-board-pomodoro-time">-- : --</div>
      </div>
    );
  }

  const { isBreak, isRunning, resetTimer, switchMode, timeLeft, toggleRunning } = pomodoro;
